...
import com.example.techytalk.databinding.ItemReciveGroupBinding;
import com.example.techytalk.databinding.ItemSentBinding;
import com.example.techytalk.databinding.ItemSentGroupBinding;
...
public class GroupMessagesAdapter extends RecyclerView.Adapter  {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if(viewType == ITEM_SENT) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.item_recive_group, parent, false);
    ...
    public class ReceiverViewHolder extends RecyclerView.ViewHolder{
        ItemReciveGroupBinding binding;
        public ReceiverViewHolder(@NonNull View itemView) {
            super(itemView);
            binding = ItemReciveGroupBinding.bind(itemView);
        }
    }
